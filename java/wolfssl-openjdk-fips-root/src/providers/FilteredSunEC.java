...
public class FilteredSunEC extends Provider {
    ...
    public FilteredSunEC() {
        ...
        try {
            ...
            System.err.println("Original SunEC loaded. Services available: " +
            ...
            System.err.println("FilteredSunEC initialized successfully with " +
                getServices().size() + " services.");

        } catch (Exception e) {
            System.err.println("Failed to initialize FilteredSunEC");
